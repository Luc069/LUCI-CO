...
} from "@/components/calendly/calendly-modal";
...
const heroCopy = {
  si: {
    headlineBeforeHighlight: "Zgradimo custom",
    headlineHighlight: "AI sistem",
    headlineAfterHighlight:
      "okoli tega, kako vaše podjetje dejansko dela.",
    primaryButton: "Rezervirajte brezplačen pogovor",
    secondaryButton: "Poglejte, kako gradimo",
    subtitleTexts: [
      "Začne se z enim pogovorom.",
      "Vi pokažete proces. Mi zgradimo sistem.",
      "Z AI-jem kot delom sistema.",
      "Dokler delo ne teče pametneje.",
    ],
  },
  en: {
    headlineBeforeHighlight: "We build custom",
    headlineHighlight: "AI systems",
    headlineAfterHighlight: "around how your company actually works.",
    primaryButton: "Book a free call",
    secondaryButton: "See how we build",
    subtitleTexts: [
      "It starts with one conversation.",
      "You show us the process. We build the system.",
      "With AI built into the system.",
      "Until the work runs smarter.",
    ],
  },
} satisfies Record<
  Locale,
  {
    headlineBeforeHighlight: string;
...
export function HomePage({ locale = "si" }: { locale?: Locale }) {
        ...
        <main className="relative z-10 flex flex-col">
                      ...
                      <div className="flex w-full justify-start">
                        <div className="w-full max-w-[54rem] text-left">
                          <h1 className="w-full text-balance font-heading text-4xl font-extrabold leading-[1.02] tracking-normal text-black sm:text-6xl lg:text-7xl">
                            {copy.headlineBeforeHighlight}{" "}
                            <ColorBendsText>
                              {copy.headlineHighlight}
                            </ColorBendsText>{" "}
                            {copy.headlineAfterHighlight}
                          </h1>
                          <MorphingText
                            texts={copy.subtitleTexts}
                            cooldownTime={3.2}
                            morphTime={0.85}
          ...
          <div className="bg-white px-0 md:px-6">
            <LandingSection className="min-h-0">
              <ProcessIntroSection locale={locale} />
            </LandingSection>

            <LandingSection className="min-h-0">
              <AiBuildSection locale={locale} />
            </LandingSection>

            <LandingSection className="min-h-0">
              <FinalOutcomeSection locale={locale} />
            </LandingSection>
